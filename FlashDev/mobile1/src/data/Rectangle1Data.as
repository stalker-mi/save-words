...
package data {
	...
	public class Rectangle1Data {
		...
		[Embed(source="asd/Rectangle1Data.asd", mimeType="application/octet-stream")]
		private var Rectangle1DataASD:Class;

		public function get geometryData():Geometry
		{
			return ASDReader.decodeGeometry(new Rectangle1DataASD());
		}
